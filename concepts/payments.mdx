---
title: "Payment Workflow: Comprobante Upload and Approval"
...
Two environment variables control the behaviour of the exam system that gates course certificates:
