---
title: "Using the IEE Edu Virtual Classroom"
...
2. If no lesson is specified, the controller falls back to `modules.first().lessons.first()`, then to the first unmodule-attached lesson.
